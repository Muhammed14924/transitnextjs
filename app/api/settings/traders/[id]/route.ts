...
export async function PUT(
  ...
  try {
    ...
    console.error("PUT Traders API error:", error);
    return serverError("Failed to update trader");
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE Traders API error:", error);
    return serverError("Failed to delete trader");
  }
}
